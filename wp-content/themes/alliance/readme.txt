== Alliance ==
Version: 3.0
Copyright: 2022, ThemeREX
WordPress version: required at least 5.0, tested up to 6.1
...
Please install and activate it before starting to use the theme Alliance.
...
Theme documentation is available on http://alliance.themerex.net/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Alliance is Fontello.
...
7) js/ScrollMagic/ScrollMagic.js
   js/ScrollMagic/amination.gsap.js
   Copyright: Jan Paepke (@janpaepke)
   Resource URI: http://scrollmagic.io
   License: Dual licensed under MIT (http://opensource.org/licenses/MIT) license and GPL (http://www.gnu.org/licenses/gpl-3.0.html)
   License URI: js/ScrollMagic/LICENSE.md
