...
if ( ! function_exists( 'alliance_wp_head' ) ) {
	...
	function alliance_wp_head() {
		if ( function_exists( 'alliance_gutenberg_is_fse_theme' ) && ! alliance_gutenberg_is_fse_theme() ) {
			?>
...
if ( ! function_exists( 'alliance_theme_fonts_links' ) ) {
	 ...
	 */
	function alliance_theme_fonts_links() {
		$links = array();
...
if ( ! function_exists( 'alliance_theme_fonts_for_editor' ) ) {
	 ...
	 *                ]
	 */
	function alliance_theme_fonts_for_editor() {
		$links = array_values( alliance_theme_fonts_links() );
