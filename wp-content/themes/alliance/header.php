	...
	<div class="<?php echo esc_attr( apply_filters( 'alliance_filter_body_wrap_class', 'body_wrap' ) ); ?>" <?php do_action('alliance_action_body_wrap_attributes'); ?>>
		...
		<div class="<?php echo esc_attr( apply_filters( 'alliance_filter_page_wrap_class', 'page_wrap' ) ); ?>" <?php do_action('alliance_action_page_wrap_attributes'); ?>>
			...
			if ( ! $alliance_full_post_loading && ! $alliance_prev_post_loading ) {
				...
				?>
				<a class="alliance_skip_link skip_to_content_link" href="#content_skip_link_anchor" tabindex="1"><?php esc_html_e( "Skip to content", 'alliance' ); ?></a>
				<?php if ( alliance_sidebar_present() ) { ?>
				<a class="alliance_skip_link skip_to_sidebar_link" href="#sidebar_skip_link_anchor" tabindex="1"><?php esc_html_e( "Skip to sidebar", 'alliance' ); ?></a>
				<?php } ?>
				<a class="alliance_skip_link skip_to_footer_link" href="#footer_skip_link_anchor" tabindex="1"><?php esc_html_e( "Skip to footer", 'alliance' ); ?></a>
