...
if ( !function_exists( 'trx_addons_widget_slider_load_responsive_styles' ) ) {
	...
	function trx_addons_widget_slider_load_responsive_styles() {
		if (trx_addons_is_on(trx_addons_get_option('debug_mode'))) {
			wp_enqueue_style( 'trx_addons-widget_slider-responsive', trx_addons_get_file_url(TRX_ADDONS_PLUGIN_WIDGETS . 'slider/slider.responsive.css'), array(), null, trx_addons_media_for_load_css_responsive( 'widget-slider', 'lg' ) );
		}
	}
}
